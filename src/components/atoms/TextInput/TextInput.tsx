...
const TextInput = (props: {label: string, setValue: React.Dispatch<React.SetStateAction<string>>, width?: string, optional?: boolean, value?: string}) => {
  ...
  return (
    <div className="text-input-area" style={style}>
        <input type="text" required value={props.value} onChange={(e)=>props.setValue(e.target.value)}/>
